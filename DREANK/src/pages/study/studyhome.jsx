        ...
        <Grid item xs={12} md={8} sx={{ display: "flex", justifyContent: "center" }}>
          <Card variant="outlined" sx={{ backgroundColor: "white", width: 200, height: 250, mr: 5 }}>
            <CardContent sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', height: '100%' }}>
              <Typography level="h3" align="center">태그로 찾기</Typography>
            </CardContent>
          ...
          <Card variant="outlined" sx={{ backgroundColor: "white", width: 200, height: 250, mr: 5, ml: 5 }}>
            <CardContent sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', height: '100%' }}>
              <Typography level="h3" align="center">일정으로 찾기</Typography>
            </CardContent>
            <CardActions sx={{ justifyContent: 'center' }}>
              <Link to="/study-search-schedule" style={{ textDecoration: 'none' }}>
                <Button sx={{ backgroundColor: "#334EAC" }}>Go!</Button>
              </Link>
            </CardActions>
          </Card>
          <Box sx={{ position: "relative" }}>
            <Card variant="outlined" sx={{ backgroundColor: "white", width: 200, height: 250, ml: 5 }}>
              <CardContent sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', height: '100%' }}>
                <Typography level="h3" align="center">스터디 만들기</Typography>
              </CardContent>
              <CardActions sx={{ justifyContent: 'center' }}>
